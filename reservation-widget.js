document.addEventListener('DOMContentLoaded', function() {
    (function() {
        ...
        // Create the iframe for the reservation widget content
        ...
        // Append iframe and close button to the overlay
        modalOverlay.appendChild(closeBtn);
        modalOverlay.appendChild(resIframe);
        document.body.appendChild(modalOverlay);

        // Create an "Open Reservation" button that toggles the modal
